...
```mermaid
graph TD;
    MJP[Momo Janta Party Headquarters] --> Exec[Executive Branch];
    MJP --> Portal[Citizen Portal];
    ...
    Portal --> Tax[Momo Tax Calculator];
    Portal --> Spice[Chutney Spice Test];
    Portal --> Heatmap[Mayonnaise Violation Heatmap];
    
    MJP --> Cultural[Cultural & Social Affairs];
    Cultural --> Baddies[Dept. of Baddies Affairs];
    Cultural --> Melody[Dept. of Melody Affairs];
    Cultural --> Inclusive[Inclusive Affairs];
